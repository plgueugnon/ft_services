...
wp core install --url="http://localhost/wordpress/" --title="ft_services" --admin_user="yo" --admin_password="yopwd" --admin_email="yo@yo.com" --path=/var/www/localhost/wordpress/ --allow-root
